...
const uri = "mongodb+srv://mini-linkedin-admin:103w3caFgqZccs0T@cluster0.bkijc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.get('/', (req, res) => {
    res.send('Welcome to mini linkedin server')
})
